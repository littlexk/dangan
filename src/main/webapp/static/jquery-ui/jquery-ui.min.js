...
(function (t) {
    ...
    t.ui = t.ui || {}, t.ui.version = "1.12.0-rc.2";
    ...
    t.effects = {effect: {}}, function (t, e) {
        ...
        t.expr && t.expr.filters && t.expr.filters.animated && (t.expr.filters.animated = function (e) {
            ...
            version: "1.12.0-rc.2", define: function (e, i, s) {
    ...
    t.uiBackCompat !== !1 && (f = t.effects.define("transfer", function (e, i) {
        ...
        var n, o, a, r = i.nodeName.toLowerCase();
        return "area" === r ? (n = i.parentNode, o = n.name, i.href && o && "map" === n.nodeName.toLowerCase() ? (a = t("img[usemap='#" + o + "']"), a.length > 0 && a.is(":visible")) : !1) : (/^(input|select|textarea|button|object)$/.test(r) ? !i.disabled : "a" === r ? i.href || s : s) && t(i).is(":visible") && e(t(i))
    }, t.extend(t.expr[":"], {
        ...
        _initWidgets: function () {
            ...
            t.each(this.options.items, function (s, n) {
                ...
                return n ? "controlgroupLabel" === s ? (o = e.element.find(n), o.each(function () {
                    t(this).contents().wrapAll("<span class='ui-controlgroup-label-contents'></span>")
                }), e._addClass(o, null, "ui-widget ui-widget-content ui-state-default"), i = i.concat(o.get()), void 0) : (t.fn[s] && (e["_" + s + "Options"] && (a = e["_" + s + "Options"]("middle")), e.element.find(n)[s](a).each(function () {
                    var e = t(this), n = e[s]("widget");
                    t.data(n[0], "ui-controlgroup-data", e[s]("instance")), i.push(n[0])
                })), void 0) : void 0
        ...
        _updateCornerClass: function (t, e) {
            var i = "ui-corner-top ui-corner-bottom ui-corner-left ui-corner-right", s = this._buildSimpleOptions(e, "label").classes.label;
        ...
        _selectmenuOptions: function (t) {
            ...
            return {
                width: e ? "auto" : !1,
                classes: {
                    middle: {"ui-selectmenu-button-open": null, "ui-selectmenu-button-closed": null},
                    first: {
                        "ui-selectmenu-button-open": "ui-corner-" + (e ? "top" : "tl"),
                        "ui-selectmenu-button-closed": "ui-corner-" + (e ? "top" : "left")
                    },
                    last: {
                        "ui-selectmenu-button-open": e ? null : "ui-corner-tr",
        ...
        refresh: function () {
            ...
            this._addClass("ui-controlgroup ui-controlgroup-" + this.options.direction), "horizontal" === this.options.direction && this._addClass(null, "ui-helper-clearfix"), this._initWidgets(), e = this.childWidgets, this.options.onlyVisible && (e = e.filter(":visible")), e.length && (t.each(["first", "last"], function (t, s) {
                ...
                n && i["_" + n.widgetName + "Options"] ? n.element[n.widgetName](i["_" + n.widgetName + "Options"](s)) : i._updateCornerClass(e[s](), s)
        ...
        _toggleClasses: function () {
            ...
            this._toggleClass(this.label, "ui-checkboxradio-checked", "ui-state-active", e), this.options.icon && "checkbox" === this.type && this._toggleClass(this.icon, null, "ui-icon-check ui-state-highlight", e)._toggleClass(this.icon, null, "ui-icon-blank", !e), "radio" === this.type && this._getRadioGroup().each(function () {
    ...
    }), t.ui.button, t.extend(t.ui, {datepicker: {version: "1.12.0-rc.2"}});
    var g;
    ...
    }, t.datepicker = new s, t.datepicker.initialized = !1, t.datepicker.uuid = (new Date).getTime(), t.datepicker.version = "1.12.0-rc.2", t.datepicker, t.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());
    var m = !1;
    t(document).on("mouseup", function () {
        ...
        _mouseDown: function (e) {
            if (!m) {
                ...
                return s && !n && this._mouseCapture(e) ? (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function () {
                    ...
                    return i._mouseUp(t)
                }, this.document.on("mousemove." + this.widgetName, this._mouseMoveDelegate).on("mouseup." + this.widgetName, this._mouseUpDelegate), e.preventDefault(), m = !0, !0)) : !0
            }
        },
        ...
        _drop: function (e, i) {
            ...
            return s && (s.currentItem || s.element)[0] !== this.element[0] ? (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                ...
                return i.options.greedy && !i.options.disabled && i.options.scope === s.options.scope && i.accept.call(i.element[0], s.currentItem || s.element) && _(s, t.extend(i, {offset: i.element.offset()}), i.options.tolerance, e) ? (n = !0, !1) : void 0
        ...
        current: null, droppables: {"default": []}, prepareOffsets: function (e, i) {
            ...
            e.options.refreshPositions && t.ui.ddmanager.prepareOffsets(e, i), t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var s, n, o, a = _(e, this, this.options.tolerance, i), r = !a && this.isover ? "isout" : a && !this.isover ? "isover" : null;

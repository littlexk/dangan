    ...
    AbstractSelect2 = clazz(Object, {
        bind: function (func) {
            ...
            if (select2 !== undefined) {
                ...
                select2.opts.element.removeClass("select2-offscreen").removeData("select2").off(".select2").attr({"tabindex": this.elementTabIndex}).prop("autofocus", this.autofocus || false).show()
            }

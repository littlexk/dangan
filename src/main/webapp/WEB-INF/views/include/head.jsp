...
<meta name="author" content="http://www.szbonus.com"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<script src="${ctxStatic}/jquery/jquery.metadata.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/bootstrap-select-1.12.2/dist/js/bootstrap-select.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/bootstrap-select-1.12.2/dist/js/i18n/defaults-zh_CN.min.js" type="text/javascript"></script>
<link href="${ctxStatic}/bootstrap-select-1.12.2/dist/css/bootstrap-select.min.css" type="text/css" rel="stylesheet" />
...
<script src="${ctxStatic}/common/getpath.js" type="text/javascript"></script>
<script src="${ctxStatic}/common/StringUtils.js" type="text/javascript"></script>
<link rel="stylesheet" href="${ctxStatic}/common/userIcon/demo.css">
<link rel="stylesheet" href="${ctxStatic}/common/userIcon/iconfont.css">
<link href="${ctxStatic}/bns/js/layer/skin/default/layer.css" rel="stylesheet" type="text/css" />
...
<link href="${ctxStatic}/common/iconFont/iconfont.css" rel="stylesheet">

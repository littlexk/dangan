...
public class DictDao extends BaseDao<Dict> {
	...
	public List<Dict> findListByValue(String type,String value){
		return find("from Dict where value like :p1 and type = :p2 and delFlag=:p3 order by value", new Parameter(value,type,Dict.DEL_FLAG_NORMAL));
	}

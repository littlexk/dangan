...
public class MenuController extends BaseController {
	...
	@RequiresUser
    @ResponseBody
    @RequestMapping(value = "shortcutMenuList")
    public List<Map<String, Object>>  getShortcutMenuList(HttpServletResponse response) {
        response.setContentType("application/json; charset=UTF-8");
        return UserUtils.getShortcutMenuList();
    }

    @ResponseBody
    @RequestMapping(value = "saveShortcutMenu")
    public String saveShortcutMenu(String data) {
    	 systemService.saveShortcutMenu(data);
        return "1";
    }
}

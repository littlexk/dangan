...
public class ColumnPositionMap {
	...
	public static Map<String,Integer> getSheetPos(Object exportType){
		...
		if("1".equals(exportType)||"2".equals(exportType)){//正高和副高
			sheetpos.put("0101", 1);//教学岗位教师系列(参照申报类型),教学岗教授
			sheetpos.put("0102", 2);//专职科研系列,研究员
			sheetpos.put("0103", 3);//工程技术系列,教授级高级工程师
			sheetpos.put("0104", 4);//实验技术系列,教授级高级实验师实验师
			sheetpos.put("0105", 5);//高教管理系列,高教管理系列研究员
			sheetpos.put("010102",6);//学生思教教师系列
		}
		if("2".equals(exportType)){//副高才有
			sheetpos.put("0106",7);//博士后副研究生(属其它系列)
		}
		
		if("3".equals(exportType)||"4".equals(exportType)||
				"3','4".equals(exportType)){//讲师或助教类
			sheetpos.put("0102", 1);//专职科研系列,研究员
			sheetpos.put("0103", 2);//工程技术系列,
			sheetpos.put("0104", 3);//实验技术系列,实验师
			sheetpos.put("0105", 4);//高教管理系列,高教管理系列研究员
	 ...
	 * 列
	 * @param postSort
	 * @param busType  youth:青年破格            默认考后聘   
	 * @return
	 * @throws Exception
	 */
	public static List<Map<String,Object>> getColumnPosMap(String postSort,String busType) throws Exception{
		if(StringUtils.equals(busType, "youth")){//青年破格
			return getYouthColumnPosMap(postSort,busType);
		}else if(StringUtils.equals(busType, "youthStaff")){
			return getYouthStaffColumnPosMap(postSort,busType);
		}
		else{
			return getAfterColumnPosMap(postSort,busType);
		}
	}
	private static List<Map<String, Object>> getYouthStaffColumnPosMap(
			String postSort, String busType) {
		if(youthColumns ==null){
			youthColumns = new ArrayList<Map<String,Object>>();
		}else{
			return youthColumns;
		}
		youthColumns.add(getColumn("ROWINDEX","0"));
		
		youthColumns.add(getColumn("DEPT_NAME","1"));
		
		youthColumns.add(getColumn("A_TECHNIC_NAME","2"));
		
		youthColumns.add(getColumn("NAME","3"));
		
		youthColumns.add(getColumn("BIRTHDAY_TECH","4"));
		
		
		/*youthColumns.add(getColumn("TECHNIC_DATE_LIMIT","5"));*/
		youthColumns.add(getColumn("INSCHOOL_DATE_TECH","5"));
		youthColumns.add(getColumn("TECHNIC_DATE_LIMIT","6"));
		/*youthColumns.add(getColumn("TECH","6"));*/
		youthColumns.add(getColumn("TECH","7"));
		youthColumns.add(getColumn("WORK","8"));
		
		youthColumns.add(getColumn("DOCTOR_TWS_SH","9"));
		
		youthColumns.add(getColumn("JOB_TWS_SH","10"));
		
		youthColumns.add(getColumn("FIVE_MEET","11"));
		
		youthColumns.add(getColumn("XK","12"));
		
		youthColumns.add(getColumn("TEAM","13"));
		
		
		youthColumns.add(getColumn("PAPER_L","14"));
		
		youthColumns.add(getColumn("AWARD_1","15"));
		
		youthColumns.add(getColumn("AWARD_2","16"));
		
		youthColumns.add(getColumn("PROJECT_1","17"));
		
		youthColumns.add(getColumn("PROJECT_4","18"));
		
		youthColumns.add(getColumn("PATENT_1","19"));
		
		youthColumns.add(getColumn("PATENT_2","20"));
		
		youthColumns.add(getColumn("PATENT_3","21"));
		
		youthColumns.add(getColumn("BOOK","22"));
		
		youthColumns.add(getColumn("REASULT","23"));
		
		youthColumns.add(getColumn("COLLEGEREVIEW","24"));
		
		youthColumns.add(getColumn("FIVE_YEAR","25"));
		
		youthColumns.add(getColumn("REMARK","26"));
		
		return youthColumns;
	}

	//青年破格 一览表导出  基础信息
	public static List<Map<String,Object>> getYouthColumnPosMap(String postSort,String busType) throws Exception{
		if(youthColumns ==null){
			youthColumns = new ArrayList<Map<String,Object>>();
		}else{
			return youthColumns;
		...
		//青年破格 一览表导出 论文
		public static List<Map<String,Object>> getYouthColumnPaperMap(String postSort,String busType) throws Exception{
			if(youthPaperColumns ==null){
				youthPaperColumns = new ArrayList<Map<String,Object>>();
			}else{
				return youthPaperColumns;
			}
			youthPaperColumns.add(getColumn("RN","0"));
			
			youthPaperColumns.add(getColumn("PAPER_NAME","1"));
			
			youthPaperColumns.add(getColumn("PUBLISH_DEPT","9"));
			
			youthPaperColumns.add(getColumn("PAPER_CLASS","11"));
			
			youthPaperColumns.add(getColumn("IMPACT_FREQUENCE","12"));
			
			youthPaperColumns.add(getColumn("PUBLISH_DATE","13"));
			return youthPaperColumns;
		}
		//青年破格 一览表导出 获奖
		public static List<Map<String,Object>> getYouthColumnAwardMap(String postSort,String busType) throws Exception{
			if(youthAwardColumns ==null){
				youthAwardColumns = new ArrayList<Map<String,Object>>();
			}else{
				return youthAwardColumns;
			}
			youthAwardColumns.add(getColumn("RN","0"));
			
			youthAwardColumns.add(getColumn("AWARD_NAME","1"));
			
			youthAwardColumns.add(getColumn("AWARD_DEPT","5"));
			
			youthAwardColumns.add(getColumn("AWARD_LEVEL","6"));
			
			youthAwardColumns.add(getColumn("AWARD_DATE","8"));
			
			youthAwardColumns.add(getColumn("RANKING","9"));
			return youthAwardColumns;
		}
		//青年破格 一览表导出 项目
		public static List<Map<String,Object>> getYouthColumnProjectMap(String postSort,String busType) throws Exception{
			if(youthProjectColumns ==null){
				youthProjectColumns = new ArrayList<Map<String,Object>>();
			}else{
				return youthProjectColumns;
			}
			youthProjectColumns.add(getColumn("RN","0"));
			
			youthProjectColumns.add(getColumn("PRO_NAME","1"));
			
			youthProjectColumns.add(getColumn("PRO_FROM","9"));
			
			youthProjectColumns.add(getColumn("PRO_LEAV","10"));
			
			youthProjectColumns.add(getColumn("PRO_DATE","11"));
			
			youthProjectColumns.add(getColumn("PRO_FUND","12"));
			
			return youthProjectColumns;
		}
		//青年破格 一览表导出 专利
		public static List<Map<String,Object>> getYouthColumnPapentMap(String postSort,String busType) throws Exception{
			if(youthPapentColumns ==null){
				youthPapentColumns = new ArrayList<Map<String,Object>>();
			}else{
				return youthPapentColumns;
			}
			youthPapentColumns.add(getColumn("RN","0"));
			
			youthPapentColumns.add(getColumn("PATEN_NAME","1"));
			
			youthPapentColumns.add(getColumn("PATEN_TYPE","9"));
			
			youthPapentColumns.add(getColumn("PATEN_DATE","11"));
			
			youthPapentColumns.add(getColumn("RANKING","12"));
	...
	//专业技术岗晋级一览表导出
	public static List<Map<String,Object>> getColumnPosMap(int type,String postSort,String tech) throws Exception{
		if("010101".equals(postSort)){
			return getTechColumnPosMap(type,postSort,tech);
			...
			return getTechColumnPosMap(type,postSort,tech);
		}else if("0102".equals(postSort)){
			return getTechColumnPosMap(type,postSort,tech);
		}else if("0103".equals(postSort)){
			return getTechColumnPosMap(type,postSort,tech);
		}else if("0104".equals(postSort)){
			return getTechColumnPosMap(type,postSort,tech);
		}else if("0105".equals(postSort)){
			return getTechColumnPosMap(type,postSort,tech);
		}else if("010102".equals(postSort)){
			return getTechColumnPosMap(type,postSort,tech);
	...
	//先上岗 一览表导出
	public static List<Map<String,Object>> getColumnPosMap(String postSort,Object exportType,int jobType) throws Exception{
		if("1".equals(exportType)||"2".equals(exportType)){
			return getColumnPosMap(postSort,jobType);
		}else{
			throw new Exception("没有"+exportType+"类型一览表!");
		}
	}
	//先上岗 一览表导出
		public static List<Map<String,Object>> getAfterColumnPosMap(String postSort,String after) throws Exception{
			if("0101".equals(postSort)){
				return getColumnPosMapByPostSort(postSort,after);
			}else if("0102".equals(postSort)){
				return getColumnPosMapByPostSort(postSort,after);
			}else if("0103".equals(postSort)){
				return getColumnPosMapByPostSort(postSort,after);
	...
	public static List<Map<String,Object>> getTechColumnPosMap(int type,String postSort,String after) throws Exception{
		...
		public static List<Map<String,Object>> getColumnPosMapByPostSort(String postSort,String after){
			if(aftcolumns ==null){
				aftcolumns = new ArrayList<Map<String,Object>>();
			}else{
				return aftcolumns;
			}
			aftcolumns.add(getColumn("HX","0"));
			
			aftcolumns.add(getColumn("DEPT_NAME","1"));
			
			aftcolumns.add(getColumn("NAME","2"));
			
			aftcolumns.add(getColumn("A_TECHNIC","3"));
			
			aftcolumns.add(getColumn("SEX","4"));
			
			aftcolumns.add(getColumn("BIRTHDAY","5"));
			
			aftcolumns.add(getColumn("WORK_DATE","6"));
			
			aftcolumns.add(getColumn("EDUCATION_NAME","7"));
			
			aftcolumns.add(getColumn("SPECIALITY","8"));
			
			aftcolumns.add(getColumn("TECHNIC_NAME","9"));
			
			aftcolumns.add(getColumn("FIRST_TECHNIC","10"));
			
			aftcolumns.add(getColumn("EXAM_YEAR3","11"));
			
			aftcolumns.add(getColumn("FOREIGN_LANG_F","12"));
			
			aftcolumns.add(getColumn("PROJECT_1","13"));
			
			aftcolumns.add(getColumn("PROJECT_3","14"));
			
			aftcolumns.add(getColumn("PROJECT_2","15"));
			
			aftcolumns.add(getColumn("PROJECT_4","16"));
			
			aftcolumns.add(getColumn("PAPER_1","17"));
			
			aftcolumns.add(getColumn("BOOK_1","18"));
			
			aftcolumns.add(getColumn("BOOK_2","19"));
			
			aftcolumns.add(getColumn("BOOK_3","20"));
			
			aftcolumns.add(getColumn("BOOK_4","21"));
			
			aftcolumns.add(getColumn("AFTER_AWARD","22"));
			
			aftcolumns.add(getColumn("COLLEGEREVIEW","23"));
			
			aftcolumns.add(getColumn("REMARK","24"));
			
			return aftcolumns;
		}
	//先上岗 一览表导出
	public static List<Map<String,Object>> getColumnPosMap(String postSort,int jobType) throws Exception{
		if("010101".equals(postSort)){
			return getColumnPosMapByPostSort(postSort,jobType);
		}else if("010103".equals(postSort)){
			return getColumnPosMapByPostSort(postSort,jobType);
		}else if("010104".equals(postSort)){
			return getColumnPosMapByPostSort(postSort,jobType);
			...
			return getColumnPosMap2(jobType);
		}else if("010102".equals(postSort)){
			return getColumnPosMap6(jobType);
		}else{
			throw new Exception("没有"+postSort+"系列!");
		}
	}
	
	public static List<Map<String,Object>> getColumnPosMap(String postSort,Object exportType) throws Exception{
		if("1".equals(exportType)||"2".equals(exportType)){
			return getColumnPosMap(postSort);
		}else if("3".equals(exportType)||"4".equals(exportType)||
				"3','4".equals(exportType)){
			return getColumnPosMapPrimary(postSort);
		}else{
			throw new Exception("没有"+exportType+"类型一览表!");
		}
	}
	
	public static List<Map<String,Object>> getColumnPosMap(String postSort) throws Exception{
		if("010101".equals(postSort)){
			return getColumnPosMapByPostSort(postSort);
		}else if("010103".equals(postSort)){
			return getColumnPosMapByPostSort(postSort);
		}else if("010104".equals(postSort)){
			return getColumnPosMapByPostSort(postSort);
	...
	public static List<Map<String,Object>> getColumnPosMapPrimary(String postSort) throws Exception{
		if("010101".equals(postSort)){
			...
			return getColumnPosMapPrimary2();
		}else if("0103".equals(postSort)){
	...
	// 先上岗 一览表导出
	// 教师系列
	public static List<Map<String, Object>> getColumnPosMapByPostSort(
			String postSort, int jobType) {
		List<Map<String, Object>> colmns = ColumnPositionMap
				.getColumnPosMap1(jobType);
		if ("0101".equals(postSort)) {//教学岗
			colmns.add(getColumn("COLLEGEREVIEW", "65"));
			colmns.add(getColumn("REMARK", "66"));
		} else {
			colmns.add(getColumn("COLLEGEREVIEW", "65"));
			colmns.add(getColumn("REMARK", "66"));
		}
	...
	// 先上岗 一览表导出
	// 教师系列
	public static List<Map<String, Object>> getColumnPosMap1(int jobType) {
		...
		columns.add(getColumn("DEPT_REASON", "63"));

		columns.add(getColumn("SUBMIT_JOB_COND", "64"));

		return columns;
	}
	// 先上岗 一览表导出
	// 专职科研系列
	public static List<Map<String, Object>> getColumnPosMap2(int jobType) {
		if (columns1 == null) {
		...
		//先上岗 单位推荐
		columns1.add(getColumn("DEPT_REASON", "50"));
		//先上岗 符合条件序号
		columns1.add(getColumn("SUBMIT_JOB_COND", "51"));
		
		columns1.add(getColumn("COLLEGEREVIEW", "52"));

		columns1.add(getColumn("REMARK", "53"));

		return columns1;
	}
	// 先上岗 一览表导出
	// 学生思教 正副高
	public static List<Map<String, Object>> getColumnPosMap6(int jobType) {
		if (columns6 == null) {
		...
		columns6.add(getColumn("DEPT_REASON", "60"));
		columns6.add(getColumn("SUBMIT_JOB_COND", "61"));
	...
	//教师系列
	public static List<Map<String,Object>> getColumnPosMapByPostSort(String postSort){
		 List<Map<String,Object>>  colmns =  ColumnPositionMap.getColumnPosMap1();
		 	if("0101".equals(postSort)){
		 		colmns.add(getColumn("","65"));
		 		colmns.add(getColumn("REMARK","66"));		
			}else{
				colmns.add(getColumn("REMARK","65"));	
			}
		 	return colmns;
	}
	//教师系列，初中级
